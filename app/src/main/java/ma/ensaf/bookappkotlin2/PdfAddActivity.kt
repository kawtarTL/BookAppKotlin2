...
import ma.ensaf.bookappkotlin2.databinding.ActivityPdfAddBinding
...
class PdfAddActivity : AppCompatActivity() {
    ...
    private fun uploadPdfToStoroage() {
    ...
    private fun uploadPdfInfoToDb(uploadedPdfUrl: String, timestamp: Long) {
        //4-upload pdf info to firebase db
        Log.d(TAG, "uploadPdfToStorage : uploading to db")
    ...
    private fun loadPdfCategories() {
        Log.d(TAG,"loaPdfCategories : Loading pdf categories")
        //init arraylist
